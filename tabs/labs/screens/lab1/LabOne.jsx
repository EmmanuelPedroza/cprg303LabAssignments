    ...
    <View style={styles.safe}>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Lab One</Text>
        </View>
        ...
        {/* Edit modal */}
        <Modal visible={!!editing} animationType="fade" transparent={true}>
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.modalButtons}>
                ...
                <Pressable onPress={() => setEditing(null)} style={[styles.smallButton, { marginLeft: 8, justifyContent: 'center', alignContent: 'center' }]}>
